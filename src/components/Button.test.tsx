...
test("button exists", () => {
    const { getByRole } = render(<BrowserRouter><Button primary={false} to="/" label="test" /></BrowserRouter>);
...
test("button is primary", () => {
    const { getByRole } = render(<BrowserRouter><Button primary={true} to="/" label="test" /></BrowserRouter>);
